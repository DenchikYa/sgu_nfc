...
public class quest_three extends AppCompatActivity {
    private static final String CHECK_THREE = "CHECK_THREE";
    private SharedPreferences mPrefs;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_quest_three);
        mPrefs = PreferenceManager.getDefaultSharedPreferences(this);
        ImageView imageView = (ImageView) findViewById(R.id.img_three);
